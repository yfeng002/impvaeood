...
To train a bi3dof-optprior detector, first computr the mu and var of optic flow fields of the training data set. 
...
def init_param():
	...
	parser.add_argument("--n_seq", type=int, default = 6, help="number of sequence to sample from one video")   
	parser.add_argument("--nd", type=int, default = 6, help="number of frames in a 3D input cube")   
	...
	parser.add_argument("--var2", type=float, default=1., help="Varaince in the horizontal direction")			   
...
def run():
	...
	# save 
	torch.save(vae.state_dict(), "bi3dof-{}-{}epoch.pt".format(args.latentprior,  epoch+1) )

#
seed()
args = init_param()
args.training = True
args.data_file = "data/nuscenes-v1.0-mini.train"
run()
